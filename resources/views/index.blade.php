...
<head>
    ...
    <!-- Dark Mode JS -->
    <script src="landing/js/darkMode.bundle.js"></script>
            ...
            <div class="container h-full">
                ...
                <div class="grid h-full items-center gap-4 md:grid-cols-12">
                    ...
                    <div class="col-span-6 flex h-full flex-col items-center justify-center py-10 md:items-start md:py-20 xl:col-span-4">
                        ...
                        <div class="flex space-x-4">
                            <a href="create.html" class="bg-accent shadow-accent-volume hover:bg-accent-dark w-36 rounded-full py-3 text-center font-semibold text-white transition-all">
                                Explore Now
                            </a>
                ...
                " fill="#9446ED"></path>
                                ...
                                <g clip-path="url(#clipping)">
                                    <!-- Bg image -->
                                    <image href="https://www.jagoanhosting.com/wp-content/uploads/2022/03/Home_LP-Logo-1.png.webp" width="200" height="200" clip-path="url(#clipping)" />
                                </g>
                            </svg>
                            <img src="landing/img/hero/3D_elements.png" alt="" class="animate-fly absolute top-0 md:-right-[10%]" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-6 gap-x-7 gap-y-14 pt-24 pb-12 md:grid-cols-12">
                    <div class="col-span-3 md:col-span-4">
                        ...
                        <a href="/" class="mb-6 inline-block">
                            <img src="image/jagoanhosting.png" class="max-h-7 dark:hidden" alt="Xhibiter | NFT Marketplace" />
                            <img src="image/jagoanhosting.png" class="hidden max-h-7 dark:block" alt="Xhibiter | NFT Marketplace" />
                        </a>
